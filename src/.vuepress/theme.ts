...
export default hopeTheme({
  ...
  repo: "gmoonwalk/gmoonwalk.github.io",

  docsDir: "src",

  blog: {
    medias: {
      GitHub: "https://github.com/gmoonwalk",
      Gmail: "mailto:moonwalk.gm@gmail.com",
  ...
  plugins: {
    ...
    comment: {
      ...
      categoryId: "DIC_kwDOJt48i84CXH5i"
    },
