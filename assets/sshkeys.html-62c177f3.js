...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function v(k,_){const a=o("ExternalLinkIcon");return d(),l("div",null,[c,e("p",null,[e("a",h,[s("github文档：Generate a new ssh key"),i(a)])]),m,e("p",null,[s("参考官方文档："),e("a",u,[s("ssh key加入到账号设置"),i(a)])]),p,e("p",null,[s("第一个Host设置是默认使用的主账号；第二个Host设置是个人账号，"),e("a",g,[s("别名为mk.github.com"),i(a)]),s("，这里的mk可以自行改写。")]),b])}const f=t(r,[["render",v],["__file","sshkeys.html.vue"]]);export{f as default};
